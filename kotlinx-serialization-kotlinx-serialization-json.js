(function (factory) {
  ...
  var _Char___init__impl__6a9atx = kotlin_kotlin.$_$.x3;
  ...
  var THROW_IAE = kotlin_kotlin.$_$.xi;
  ...
  var SerializableWith = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.p2;
  var numberRangeToNumber = kotlin_kotlin.$_$.ud;
  var ClosedRange = kotlin_kotlin.$_$.ee;
  var isInterface = kotlin_kotlin.$_$.kd;
  var contains = kotlin_kotlin.$_$.je;
  var convertToInt = kotlin_kotlin.$_$.lb;
  var NumberFormatException_init_$Create$ = kotlin_kotlin.$_$.g3;
  var toDoubleOrNull = kotlin_kotlin.$_$.jh;
  var toDouble = kotlin_kotlin.$_$.kh;
  ...
  var toLongOrNull = kotlin_kotlin.$_$.nh;
  var toULongOrNull = kotlin_kotlin.$_$.sh;
  ...
  var isLetter = kotlin_kotlin.$_$.cg;
  var Char = kotlin_kotlin.$_$.hi;
  var last = kotlin_kotlin.$_$.ig;
  var toString_1 = kotlin_kotlin.$_$.e4;
  var charCodeAt = kotlin_kotlin.$_$.jc;
  var isUpperCase = kotlin_kotlin.$_$.eg;
  var fromInt = kotlin_kotlin.$_$.pb;
  var _UInt___init__impl__l7qpdl = kotlin_kotlin.$_$.s4;
  var UInt__toString_impl_dbgl21 = kotlin_kotlin.$_$.u4;
  var _ULong___init__impl__c78o9k = kotlin_kotlin.$_$.b5;
  var ULong__toString_impl_f9au7k = kotlin_kotlin.$_$.d5;
  var _UByte___init__impl__g9hnc4 = kotlin_kotlin.$_$.j4;
  var UByte__toString_impl_v72jg = kotlin_kotlin.$_$.l4;
  var _UShort___init__impl__jigrne = kotlin_kotlin.$_$.k5;
  var UShort__toString_impl_edaoee = kotlin_kotlin.$_$.m5;
  ...
  var coerceAtMost = kotlin_kotlin.$_$.he;
  ...
  var arrayCopy = kotlin_kotlin.$_$.r6;
  ...
  var Char__toInt_impl_vasixd = kotlin_kotlin.$_$.d4;
  var ensureNotNull = kotlin_kotlin.$_$.oj;
  var DeepRecursiveFunction = kotlin_kotlin.$_$.ki;
  var invoke = kotlin_kotlin.$_$.pj;
  var CoroutineImpl = kotlin_kotlin.$_$.ua;
  var DeepRecursiveScope = kotlin_kotlin.$_$.li;
  ...
  var SuspendFunction2 = kotlin_kotlin.$_$.xa;
  ...
  var substringBefore = kotlin_kotlin.$_$.ch;
  var removeSuffix = kotlin_kotlin.$_$.ng;
  var substringAfter = kotlin_kotlin.$_$.zg;
  var contains_0 = kotlin_kotlin.$_$.mf;
  var plus = kotlin_kotlin.$_$.wj;
  ...
  var indexOf = kotlin_kotlin.$_$.ag;
  var last_0 = kotlin_kotlin.$_$.q8;
  var removeLast = kotlin_kotlin.$_$.c9;
  var lastIndexOf = kotlin_kotlin.$_$.hg;
  ...
  var indexOf_0 = kotlin_kotlin.$_$.zf;
  var substring = kotlin_kotlin.$_$.fh;
  var chunked = kotlin_kotlin.$_$.jf;
    ...
    while ($this.lexer_1.canConsumeValue_oljqd7_k$()) {
      ...
      if (!(lastToken === 4)) {
        ...
        if (!condition) {
          ...
          tmp0.fail$default_vqx2ls_k$(tmp$ret$2, position);
        }
      }
    }
    if (lastToken === 8) {
      ...
      if (decodingKey) {
        if ($this.currentIndex_1 === -1) {
          ...
          if (!condition_0) {
            ...
            tmp0_0.fail$default_vqx2ls_k$(tmp$ret$3, position_0);
          }
        }
      }
      ...
      if (tmp0_elvis_lhs == null) {
        ...
        $l$block: {
          ...
          if (!(tmp0 instanceof JsonObject)) {
            ...
            var tmp$ret$2 = this.lexer_1.get_path_wos8ry_k$().getPath_18su3p_k$();
  ...
  function getPrimitiveValue($this, tag, primitiveName, convert) {
    ...
    if (!(value instanceof JsonPrimitive)) {
      ...
      var tmp$ret$2 = $this.renderTagStack_ixxubu_k$(tag);
      throw JsonDecodingException_0(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + primitiveName + ' at element: ' + tmp$ret$2, toString(value));
    }
    var literal = value;
    try {
  ...
  protoOf(AbstractJsonTreeDecoder).decodeSerializableValue_xpnpad_k$ = function (deserializer) {
    ...
    $l$block: {
      ...
      if (!(tmp0 instanceof JsonObject)) {
        ...
        var tmp$ret$2 = this.renderTagStack_rja478_k$();
    ...
    if (tmp_0) {
      ...
      if (equals(tmp0_subject, MAP_getInstance())) {
        ...
        if (tmp_5) {
          ...
          if (this_0.get_configuration_uqypjh_k$().get_allowStructuredMapKeys_fk21t_k$()) {
            ...
            if (!(currentObject instanceof JsonArray)) {
              ...
              var tmp$ret$11 = this.renderTagStack_rja478_k$();
        ...
        if (!(currentObject instanceof JsonObject)) {
          ...
          var tmp$ret$14 = this.renderTagStack_rja478_k$();
  ...
  protoOf(AbstractJsonTreeDecoder).getPrimitiveValue_cue515_k$ = function (tag, descriptor) {
    ...
    if (!(tmp2 instanceof JsonPrimitive)) {
      ...
      var tmp$ret$2 = this.renderTagStack_ixxubu_k$(tag);
      throw JsonDecodingException_0(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$2, toString(tmp2));
    }
    return tmp2;
  };
  protoOf(AbstractJsonTreeDecoder).decodeTaggedEnum_lbnta6_k$ = function (tag, enumDescriptor) {
    ...
    if (!(tmp2 instanceof JsonPrimitive)) {
      ...
      var tmp$ret$3 = this.renderTagStack_ixxubu_k$(tag);
  ...
  protoOf(AbstractJsonLexer).consumeNextToken_dugwfi_k$ = function (expected) {
    ...
    if (!(token === expected)) {
      ...
      this.fail$default_vqx2ls_k$(tmp$ret$1, position);
    }
    return token;
  };
  protoOf(AbstractJsonLexer).unexpectedToken_ad91it_k$ = function (expected) {
    ...
    this.fail$default_vqx2ls_k$(tmp$ret$3, position);
  };
