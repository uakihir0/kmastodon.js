(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin-kotlin-stdlib.js', './ktor-ktor-io.js', './ktor-ktor-http.js', './ktor-ktor-client-ktor-client-core.js', './ktor-ktor-utils.js', './kotlinx-serialization-kotlinx-serialization-json.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin-kotlin-stdlib.js'), require('./ktor-ktor-io.js'), require('./ktor-ktor-http.js'), require('./ktor-ktor-client-ktor-client-core.js'), require('./ktor-ktor-utils.js'), require('./kotlinx-serialization-kotlinx-serialization-json.js'));
  else {
    ...
    if (typeof globalThis['ktor-ktor-client-ktor-client-core'] === 'undefined') {
      throw new Error("Error loading module 'khttpclient'. Its dependency 'ktor-ktor-client-ktor-client-core' was not found. Please, check whether 'ktor-ktor-client-ktor-client-core' is loaded prior to 'khttpclient'.");
    }
    ...
    globalThis.khttpclient = factory(typeof khttpclient === 'undefined' ? {} : khttpclient, globalThis['kotlin-kotlin-stdlib'], globalThis['ktor-ktor-io'], globalThis['ktor-ktor-http'], globalThis['ktor-ktor-client-ktor-client-core'], globalThis['ktor-ktor-utils'], globalThis['kotlinx-serialization-kotlinx-serialization-json']);
  }
  ...
  var HttpClient = kotlin_io_ktor_ktor_client_core.$_$.i;
  ...
  var URLBuilder = kotlin_io_ktor_ktor_http.$_$.l1;
  var takeFrom = kotlin_io_ktor_ktor_http.$_$.f2;
  var headers = kotlin_io_ktor_ktor_client_core.$_$.f;
  var timeout = kotlin_io_ktor_ktor_client_core.$_$.a;
  var ArrayList_init_$Create$ = kotlin_kotlin.$_$.m;
  var MultiPart_getInstance = kotlin_io_ktor_ktor_http.$_$.g;
  var contentType = kotlin_io_ktor_ktor_http.$_$.w1;
  var formData = kotlin_io_ktor_ktor_client_core.$_$.d;
  var MultiPartFormDataContent = kotlin_io_ktor_ktor_client_core.$_$.c;
  ...
  var ParametersBuilder = kotlin_io_ktor_ktor_http.$_$.k1;
  var FormDataContent = kotlin_io_ktor_ktor_client_core.$_$.b;
  ...
  var HttpStatement = kotlin_io_ktor_ktor_client_core.$_$.h;
  ...
  var toMap = kotlin_io_ktor_ktor_utils.$_$.g1;
  ...
  var decodeToString = kotlin_kotlin.$_$.ef;
  ...
  function HttpRequest$proceed$lambda_2($params, $files) {
    return function ($this$formData) {
      ...
      while (_iterator__ex2g4s_0.hasNext_bitz1p_k$()) {
        ...
        $this$formData.append_57lmty_k$(tmp, tmp_0, tmp$ret$4);
      }
      return Unit_getInstance();
    };
  }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            this.ARGUMENT0__1 = Companion_getInstance_3();
            var this_0 = new HttpRequestBuilder();
            this_0.set_method_hoo95u_k$(this.method_1);
            if (!(req.url_1 == null)) {
              var tmp0_0 = req.url_1;
            ...
            if (!this._this__u8e3s4__1.forceMultipartFormData_1 && !this._this__u8e3s4__1.forceApplicationFormUrlEncoded_1 && req.params_1.get_size_woubt6_k$() === 1 && canSendOnly(this._this__u8e3s4__1, first(req.params_1))) {
                ...
                if (tmp_7) {
                  if (this._this__u8e3s4__1.forceApplicationFormUrlEncoded_1) {
                    ...
                    if (body_0 == null) {
                      ...
                      this_0.set_bodyType_8pgqkl_k$(new TypeInfo(tmp_8, tmp_9));
                    } else {
                      if (body_0 instanceof OutgoingContent) {
                        ...
                        this_0.set_bodyType_8pgqkl_k$(new TypeInfo(tmp_11, tmp_12));
                      }
                    }
                  } else {
                    ...
                    if (body_1 == null) {
                      ...
                      this_0.set_bodyType_8pgqkl_k$(new TypeInfo(tmp_14, tmp_15));
                    } else {
          ...
          case 1:
            ...
            suspendResult = this.ARGUMENT0__1.from_47xwmg_k$(ARGUMENT, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
