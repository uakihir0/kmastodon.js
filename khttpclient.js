(function (factory) {
  ...
  var toMap = kotlin_io_ktor_ktor_utils.$_$.e1;
          ...
          case 0:
            ...
            if (!this._this__u8e3s4__1.forceMultipartFormData_1 && !this._this__u8e3s4__1.forceApplicationFormUrlEncoded_1 && this.req0__1.params_1.get_size_woubt6_k$() === 1 && canSendOnly(this._this__u8e3s4__1, first(this.req0__1.params_1))) {
              ...
              if (body == null) {
                ...
                this_1.set_bodyType_8pgqkl_k$(new TypeInfo(tmp_5, tmp_6));
              } else {
                if (body instanceof OutgoingContent) {
                  ...
                  this_1.set_body_slfhxt_k$(body);
                  var tmp_8 = getKClass(ByteArrayContent);
                  var tmp_9;
                  try {
                    tmp_9 = createKType(getKClass(ByteArrayContent), arrayOf([]), false);
                  } catch ($p) {
                    var tmp_10;
                    if ($p instanceof Error) {
                  ...
                  this_1.set_bodyType_8pgqkl_k$(new TypeInfo(tmp_8, tmp_9));
                }
              }
            } else {
                ...
                if (tmp_11) {
                  if (this._this__u8e3s4__1.forceApplicationFormUrlEncoded_1) {
                    ...
                    if (body_0 == null) {
                      ...
                      this_1.set_bodyType_8pgqkl_k$(new TypeInfo(tmp_12, tmp_13));
                    } else {
                      if (body_0 instanceof OutgoingContent) {
                        ...
                        this_1.set_bodyType_8pgqkl_k$(new TypeInfo(tmp_15, tmp_16));
                      }
                    }
                  } else {
                    ...
                    if (body_1 == null) {
                      ...
                      this_1.set_bodyType_8pgqkl_k$(new TypeInfo(tmp_18, tmp_19));
                    } else {
                      if (body_1 instanceof OutgoingContent) {
                        ...
                        this_1.set_body_slfhxt_k$(body_1);
                        var tmp_21 = getKClass(MultiPartFormDataContent);
                        var tmp_22;
                        try {
                          tmp_22 = createKType(getKClass(MultiPartFormDataContent), arrayOf([]), false);
                        } catch ($p) {
                          var tmp_23;
                          if ($p instanceof Error) {
                        ...
                        this_1.set_bodyType_8pgqkl_k$(new TypeInfo(tmp_21, tmp_22));
                      }
                    }
                  }
                }
