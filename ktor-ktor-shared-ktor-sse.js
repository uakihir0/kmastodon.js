(function (factory) {
  ...
  protoOf(TypedServerSentEvent).equals = function (other) {
    ...
    if (!equals(this.data_1, tmp0_other_with_cast.data_1))
      return false;
    if (!(this.event_1 == tmp0_other_with_cast.event_1))
      return false;
    if (!(this.id_1 == tmp0_other_with_cast.id_1))
      return false;
    if (!equals(this.retry_1, tmp0_other_with_cast.retry_1))
      return false;
    if (!(this.comments_1 == tmp0_other_with_cast.comments_1))
      return false;
    return true;
  };
  ...
  protoOf(ServerSentEvent).equals = function (other) {
    ...
    if (!(this.data_1 == tmp0_other_with_cast.data_1))
      return false;
    if (!(this.event_1 == tmp0_other_with_cast.event_1))
      return false;
    if (!(this.id_1 == tmp0_other_with_cast.id_1))
