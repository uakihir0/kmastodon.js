(function (factory) {
  ...
  var MastodonFactory_instance = kotlin_work_socialhub_kmastodon_core.$_$.a;
  ...
  protoOf(KmastodonFactory).g4w = function (uri, userAccessToken, service) {
    return MastodonFactory_instance.instance(uri, userAccessToken, service);
  };
  protoOf(KmastodonFactory).instance = function (uri, userAccessToken, service, $super) {
    ...
    return $super === VOID ? this.g4w(uri, userAccessToken, service) : $super.g4w.call(this, uri, userAccessToken, service);
  };
  ...
  //region block: init
  KmastodonFactory_instance = new KmastodonFactory();
  //endregion
