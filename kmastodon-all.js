(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kmastodon-core.js', './kotlin-kotlin-stdlib.js', './ktor-ktor-client-ktor-client-core.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kmastodon-core.js'), require('./kotlin-kotlin-stdlib.js'), require('./ktor-ktor-client-ktor-client-core.js'));
  else {
    ...
    if (typeof globalThis['ktor-ktor-client-ktor-client-core'] === 'undefined') {
      throw new Error("Error loading module 'work.socialhub.kmastodon:all'. Its dependency 'ktor-ktor-client-ktor-client-core' was not found. Please, check whether 'ktor-ktor-client-ktor-client-core' is loaded prior to 'work.socialhub.kmastodon:all'.");
    }
    globalThis['work.socialhub.kmastodon:all'] = factory(typeof globalThis['work.socialhub.kmastodon:all'] === 'undefined' ? {} : globalThis['work.socialhub.kmastodon:all'], globalThis['kmastodon-core'], globalThis['kotlin-kotlin-stdlib'], globalThis['ktor-ktor-client-ktor-client-core']);
  }
