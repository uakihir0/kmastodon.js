(function (factory) {
  ...
  var Annotation = kotlin_kotlin.$_$.rh;
  ...
  var StringCompanionObject_getInstance = kotlin_kotlin.$_$.c5;
  ...
  var Grouping = kotlin_kotlin.$_$.s5;
  ...
  var KClass = kotlin_kotlin.$_$.ie;
  var Triple = kotlin_kotlin.$_$.ni;
  var Pair = kotlin_kotlin.$_$.ii;
  ...
  var longArray = kotlin_kotlin.$_$.hd;
  ...
  var invert = kotlin_kotlin.$_$.ib;
  var countTrailingZeroBits = kotlin_kotlin.$_$.bj;
  var indexOf = kotlin_kotlin.$_$.a8;
  var contentToString = kotlin_kotlin.$_$.c7;
  var Enum = kotlin_kotlin.$_$.ai;
  var toString_0 = kotlin_kotlin.$_$.oj;
  var KTypeParameter = kotlin_kotlin.$_$.oe;
  var HashSet_init_$Create$_1 = kotlin_kotlin.$_$.r;
  var booleanArray = kotlin_kotlin.$_$.xb;
  var emptyMap = kotlin_kotlin.$_$.s7;
  var contentHashCode = kotlin_kotlin.$_$.b7;
  var Companion_getInstance_1 = kotlin_kotlin.$_$.i5;
  var isCharArray = kotlin_kotlin.$_$.xc;
  var charArray = kotlin_kotlin.$_$.ac;
  var DoubleCompanionObject_getInstance = kotlin_kotlin.$_$.y4;
  var isDoubleArray = kotlin_kotlin.$_$.zc;
  var FloatCompanionObject_getInstance = kotlin_kotlin.$_$.z4;
  var isFloatArray = kotlin_kotlin.$_$.ad;
  ...
  var _ULongArray___get_size__impl__ju6dtr = kotlin_kotlin.$_$.j4;
  var ULongArray = kotlin_kotlin.$_$.si;
  var _ULongArray___init__impl__twm1l3 = kotlin_kotlin.$_$.f4;
  var _ULong___init__impl__c78o9k = kotlin_kotlin.$_$.c4;
  var ULongArray__get_impl_pr71q9 = kotlin_kotlin.$_$.h4;
  var _ULong___get_data__impl__fggpzb = kotlin_kotlin.$_$.d4;
  var IntCompanionObject_getInstance = kotlin_kotlin.$_$.a5;
  var isIntArray = kotlin_kotlin.$_$.bd;
  var Companion_getInstance_4 = kotlin_kotlin.$_$.m5;
  var _UIntArray___get_size__impl__r6l8ci = kotlin_kotlin.$_$.a4;
  var UIntArray = kotlin_kotlin.$_$.qi;
  var _UIntArray___init__impl__ghjpc6 = kotlin_kotlin.$_$.w3;
  var _UInt___init__impl__l7qpdl = kotlin_kotlin.$_$.t3;
  var UIntArray__get_impl_gp5kza = kotlin_kotlin.$_$.y3;
  var _UInt___get_data__impl__f0vqqw = kotlin_kotlin.$_$.u3;
  var ShortCompanionObject_getInstance = kotlin_kotlin.$_$.b5;
  var isShortArray = kotlin_kotlin.$_$.ed;
  var Companion_getInstance_5 = kotlin_kotlin.$_$.o5;
  var _UShortArray___get_size__impl__jqto1b = kotlin_kotlin.$_$.s4;
  var UShortArray = kotlin_kotlin.$_$.ui;
  var _UShortArray___init__impl__9b26ef = kotlin_kotlin.$_$.o4;
  var _UShort___init__impl__jigrne = kotlin_kotlin.$_$.l4;
  var UShortArray__get_impl_fnbhmx = kotlin_kotlin.$_$.q4;
  var _UShort___get_data__impl__g0245 = kotlin_kotlin.$_$.m4;
  var ByteCompanionObject_getInstance = kotlin_kotlin.$_$.x4;
  var isByteArray = kotlin_kotlin.$_$.wc;
  var Companion_getInstance_6 = kotlin_kotlin.$_$.l5;
  var _UByteArray___get_size__impl__h6pkdv = kotlin_kotlin.$_$.r3;
  var UByteArray = kotlin_kotlin.$_$.oi;
  var _UByteArray___init__impl__ip4y9n = kotlin_kotlin.$_$.o3;
  var _UByte___init__impl__g9hnc4 = kotlin_kotlin.$_$.k3;
  var UByteArray__get_impl_t5f3hv = kotlin_kotlin.$_$.p3;
  var _UByte___get_data__impl__jof9qr = kotlin_kotlin.$_$.l3;
  var BooleanCompanionObject_getInstance = kotlin_kotlin.$_$.w4;
  var isBooleanArray = kotlin_kotlin.$_$.vc;
  ...
  var _ULongArray___get_storage__impl__28e64j = kotlin_kotlin.$_$.k4;
  var _ULongArray___init__impl__twm1l3_0 = kotlin_kotlin.$_$.g4;
  var ULongArray__set_impl_z19mvh = kotlin_kotlin.$_$.i4;
  var copyOf_3 = kotlin_kotlin.$_$.m7;
  var _UIntArray___get_storage__impl__92a0v0 = kotlin_kotlin.$_$.b4;
  var _UIntArray___init__impl__ghjpc6_0 = kotlin_kotlin.$_$.x3;
  var UIntArray__set_impl_7f2zu2 = kotlin_kotlin.$_$.z3;
  var copyOf_4 = kotlin_kotlin.$_$.e7;
  var _UShortArray___get_storage__impl__t2jpv5 = kotlin_kotlin.$_$.t4;
  var _UShortArray___init__impl__9b26ef_0 = kotlin_kotlin.$_$.p4;
  var UShortArray__set_impl_6d8whp = kotlin_kotlin.$_$.r4;
  var copyOf_5 = kotlin_kotlin.$_$.i7;
  var _UByteArray___get_storage__impl__d4kctt = kotlin_kotlin.$_$.s3;
  var _UByteArray___init__impl__ip4y9n_0 = kotlin_kotlin.$_$.n3;
  var UByteArray__set_impl_jvcicn = kotlin_kotlin.$_$.q3;
  ...
  var ULong = kotlin_kotlin.$_$.ti;
  var UInt = kotlin_kotlin.$_$.ri;
  var UByte = kotlin_kotlin.$_$.pi;
  var UShort = kotlin_kotlin.$_$.vi;
  var noWhenBranchMatchedException = kotlin_kotlin.$_$.kj;
  var asSequence = kotlin_kotlin.$_$.s6;
  var nextAssociatedObjectId = kotlin_kotlin.$_$.kd;
  ...
  var get_longArrayClass = kotlin_kotlin.$_$.kb;
  ...
  function CharArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_9(Companion_getInstance_1()));
  }
  ...
  function initBuiltins() {
    return mapOf([to(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), serializer_0(StringCompanionObject_getInstance())), to(getKClass(Char), serializer_9(Companion_getInstance_1())), to(PrimitiveClasses_getInstance().get_charArrayClass_7lhfoe_k$(), CharArraySerializer()), to(PrimitiveClasses_getInstance().get_doubleClass_dahzcy_k$(), serializer_10(DoubleCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_doubleArrayClass_84hee1_k$(), DoubleArraySerializer()), to(PrimitiveClasses_getInstance().get_floatClass_xlwq2t_k$(), serializer_11(FloatCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_floatArrayClass_qngmha_k$(), FloatArraySerializer()), to(getKClass(Long), serializer_5(Companion_getInstance_2())), to(get_longArrayClass(), LongArraySerializer()), to(getKClass(ULong), serializer_1(Companion_getInstance_3())), to(getKClass(ULongArray), ULongArraySerializer()), to(PrimitiveClasses_getInstance().get_intClass_mw4y9a_k$(), serializer_6(IntCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_intArrayClass_h44pbv_k$(), IntArraySerializer()), to(getKClass(UInt), serializer_2(Companion_getInstance_4())), to(getKClass(UIntArray), UIntArraySerializer()), to(PrimitiveClasses_getInstance().get_shortClass_5ajsv9_k$(), serializer_8(ShortCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_shortArrayClass_c1p7wy_k$(), ShortArraySerializer()), to(getKClass(UShort), serializer_4(Companion_getInstance_5())), to(getKClass(UShortArray), UShortArraySerializer()), to(PrimitiveClasses_getInstance().get_byteClass_pu7s61_k$(), serializer_7(ByteCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_byteArrayClass_57my8g_k$(), ByteArraySerializer()), to(getKClass(UByte), serializer_3(Companion_getInstance_6())), to(getKClass(UByteArray), UByteArraySerializer()), to(PrimitiveClasses_getInstance().get_booleanClass_d285fr_k$(), serializer_12(BooleanCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_booleanArrayClass_lnbwea_k$(), BooleanArraySerializer()), to(getKClass(Unit), serializer_13(Unit_getInstance())), to(PrimitiveClasses_getInstance().get_nothingClass_7ivpcc_k$(), NothingSerializer()), to(getKClass(Duration), serializer_14(Companion_getInstance())), to(getKClass(Uuid), serializer_15(Companion_getInstance_0()))]);
  }
  ...
  _.$_$.c2 = throwArrayMissingFieldException;
