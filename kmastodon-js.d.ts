...
export declare namespace work.socialhub.kmastodon.api {
    interface FollowRequestsResource {
        ...
        authorizeFollowRequest(request: work.socialhub.kmastodon.api.request.followrequests.FollowRequestsAuthorizeFollowRequestRequest): work.socialhub.kmastodon.api.response.ResponseUnit;
        rejectFollowRequest(request: work.socialhub.kmastodon.api.request.followrequests.FollowRequestsRejectFollowRequestRequest): work.socialhub.kmastodon.api.response.ResponseUnit;
        readonly __doNotUseOrImplementIt: {
...
export declare namespace work.socialhub.kmastodon.api {
    interface ListsResource {
        ...
        deleteList(request: work.socialhub.kmastodon.api.request.lists.ListsDeleteListRequest): work.socialhub.kmastodon.api.response.ResponseUnit;
        addAccountsToList(request: work.socialhub.kmastodon.api.request.lists.ListsAddAccountsToListRequest): work.socialhub.kmastodon.api.response.ResponseUnit;
        deleteAccountsToList(request: work.socialhub.kmastodon.api.request.lists.ListsDeleteAccountsToListRequest): work.socialhub.kmastodon.api.response.ResponseUnit;
        readonly __doNotUseOrImplementIt: {
...
export declare namespace work.socialhub.kmastodon.api {
    interface NotificationsResource {
        ...
        clearNotifications(): work.socialhub.kmastodon.api.response.ResponseUnit;
...
export declare namespace work.socialhub.kmastodon.api {
    interface StatusesResource {
        ...
        deleteStatus(request: work.socialhub.kmastodon.api.request.statuses.StatusesDeleteStatusRequest): work.socialhub.kmastodon.api.response.ResponseUnit;
