(function (factory) {
  ...
  var toString = kotlin_kotlin.$_$.oj;
  ...
  var newThrowable = kotlin_kotlin.$_$.jd;
  var stackTraceToString = kotlin_kotlin.$_$.mj;
  ...
  var cancel = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.k1;
  var initMetadataForLambda = kotlin_kotlin.$_$.sc;
  var KSuspendFunction0 = kotlin_kotlin.$_$.ne;
  ...
  var encodeToByteArray = kotlin_kotlin.$_$.gf;
  ...
  var replace_0 = kotlin_kotlin.$_$.fg;
  ...
  var trim = kotlin_kotlin.$_$.mh;
  var toByte = kotlin_kotlin.$_$.qd;
  var decodeToString_0 = kotlin_kotlin.$_$.ef;
  ...
  initMetadataForCoroutine($readUntilCOROUTINE$, CoroutineImpl);
  ...
  initMetadataForCoroutine($readUntil$appendPartialMatchCOROUTINE$, CoroutineImpl);
  ...
  function readUTF8Line(_this__u8e3s4, max, $completion) {
    ...
    var tmp = new $readUTF8LineCOROUTINE$(_this__u8e3s4, max, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  ...
  function readUntil(_this__u8e3s4, matchString, writeChannel, limit, ignoreMissing, $completion) {
    ...
    var tmp = new $readUntilCOROUTINE$(_this__u8e3s4, matchString, writeChannel, limit, ignoreMissing, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  function readUTF8LineTo(_this__u8e3s4, out, max, lineEnding, $completion) {
    max = max === VOID ? 2147483647 : max;
    lineEnding = lineEnding === VOID ? Companion_getInstance_2().get_Any_jwln0w_k$() : lineEnding;
  ...
  function readUTF8LineTo_0(_this__u8e3s4, out, max, $completion) {
    max = max === VOID ? 2147483647 : max;
    return readUTF8LineTo(_this__u8e3s4, out, max, Companion_getInstance_2().get_Any_jwln0w_k$(), $completion);
  }
  ...
  function buildPartialMatchTable(byteString) {
    var table = new Int32Array(byteString.get_size_woubt6_k$());
    var j = 0;
    var inductionVariable = 1;
    var last = byteString.get_size_woubt6_k$();
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        while (j > 0 && !(byteString.get_c1px32_k$(i) === byteString.get_c1px32_k$(j))) {
          j = table[j - 1 | 0];
        }
        if (byteString.get_c1px32_k$(i) === byteString.get_c1px32_k$(j)) {
          j = j + 1 | 0;
        }
        table[i] = j;
      }
  ...
  function readUntil$appendPartialMatch($writeChannel, matchBuffer, matchIndex, rc, $completion) {
    var tmp = new $readUntil$appendPartialMatchCOROUTINE$($writeChannel, matchBuffer, matchIndex, rc, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  function readUntil$resetPartialMatch(matchIndex, $matchString, partialMatchTable, byte) {
    while (matchIndex._v > 0 && !(byte === $matchString.get_c1px32_k$(matchIndex._v))) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            this.set_state_rjd8d0_k$(1);
            suspendResult = readUTF8LineTo_0(this._this__u8e3s4__1, this.result0__1, this.max_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  function $readUntilCOROUTINE$(_this__u8e3s4, matchString, writeChannel, limit, ignoreMissing, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
  ...
  protoOf($readUntilCOROUTINE$).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
        switch (tmp) {
          case 0:
            ...
            this.partialMatchTable5__1 = buildPartialMatchTable(this.matchString_1);
            this.matchIndex1__1 = {_v: 0};
            this.matchBuffer2__1 = new Int8Array(this.matchString_1.get_size_woubt6_k$());
            this.rc0__1 = {_v: new Long(0, 0)};
            this.set_state_rjd8d0_k$(1);
            continue $sm;
          case 1:
            if (!!this._this__u8e3s4__1.get_isClosedForRead_ajcc1s_k$()) {
            ...
            this.set_state_rjd8d0_k$(2);
            suspendResult = readByte(this._this__u8e3s4__1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            ...
            continue $sm;
          case 2:
            this.byte4__1 = suspendResult;
            if (this.matchIndex1__1._v > 0 && !(this.byte4__1 === this.matchString_1.get_c1px32_k$(this.matchIndex1__1._v))) {
              this.set_state_rjd8d0_k$(3);
              suspendResult = readUntil$appendPartialMatch(this.writeChannel_1, this.matchBuffer2__1, this.matchIndex1__1, this.rc0__1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 3:
            readUntil$resetPartialMatch(this.matchIndex1__1, this.matchString_1, this.partialMatchTable5__1, this.byte4__1);
            this.set_state_rjd8d0_k$(4);
            continue $sm;
          case 4:
            if (this.byte4__1 === this.matchString_1.get_c1px32_k$(this.matchIndex1__1._v)) {
              var tmp_0 = this;
              this.matchBuffer2__1[this.matchIndex1__1._v] = this.byte4__1;
              this.matchIndex1__1._v = this.matchIndex1__1._v + 1 | 0;
              if (this.matchIndex1__1._v === this.matchString_1.get_size_woubt6_k$()) {
                return this.rc0__1._v;
              }
              ...
              this.set_state_rjd8d0_k$(5);
              suspendResult = writeByte(this.writeChannel_1, this.byte4__1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 5:
            var tmp_1 = this;
            var _unary__edvuaz = this.rc0__1._v;
            this.rc0__1._v = add(_unary__edvuaz, get_ONE());
            tmp_1.WHEN_RESULT3__1 = _unary__edvuaz;
            this.set_state_rjd8d0_k$(6);
            continue $sm;
          case 6:
            if (compare(this.rc0__1._v, this.limit_1) > 0) {
              throw IOException_init_$Create$('Limit of ' + this.limit_1.toString() + ' bytes exceeded while scanning for "' + decodeToString(this.matchString_1) + '"');
            }
          ...
          case 8:
            throw IOException_init_$Create$('Expected "' + toSingleLineString(this.matchString_1) + '" but encountered end of input');
          case 9:
            this.set_state_rjd8d0_k$(10);
            suspendResult = this.writeChannel_1.flush_4wsz1p_k$(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf($readUTF8LineToCOROUTINE$).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
        switch (tmp) {
          ...
          case 6:
            ...
            this.lineBuffer6__1 = this.this2__1;
            this.set_state_rjd8d0_k$(7);
            continue $sm;
          case 7:
            if (!!this._this__u8e3s4__1.get_isClosedForRead_ajcc1s_k$()) {
          ...
          case 8:
            ...
            var b = this._this__u8e3s4__1.get_readBuffer_yjmj9b_k$().readByte_ectjk2_k$();
            if (b === 13) {
              if (this._this__u8e3s4__1.get_readBuffer_yjmj9b_k$().exhausted_p1jt55_k$()) {
                this.set_state_rjd8d0_k$(10);
                suspendResult = this._this__u8e3s4__1.awaitContent$default_rxihsg_k$(VOID, this);
              ...
              if (b === 10) {
                readUTF8LineTo$checkLineEndingAllowed(this.lineEnding_1, Companion_getInstance_2().get_LF_b8k5ow_k$());
                this.out_1.append_jgojdo_k$(readString(this.lineBuffer6__1));
                this.tmp$ret$05__1 = true;
                this.set_exceptionState_fex74n_k$(21);
                this.set_state_rjd8d0_k$(15);
                continue $sm;
              } else {
                this.lineBuffer6__1.writeByte_9ih3z3_k$(b);
                this.set_state_rjd8d0_k$(9);
                continue $sm;
              }
            }
          ...
          case 11:
            if (this._this__u8e3s4__1.get_readBuffer_yjmj9b_k$().get_buffer_bmaafd_k$().get_ugtq3c_k$(new Long(0, 0)) === 10) {
              readUTF8LineTo$checkLineEndingAllowed(this.lineEnding_1, Companion_getInstance_2().get_CRLF_gdqv27_k$());
              discard_0(this._this__u8e3s4__1.get_readBuffer_yjmj9b_k$(), new Long(1, 0));
            } else {
              readUTF8LineTo$checkLineEndingAllowed(this.lineEnding_1, Companion_getInstance_2().get_CR_oadccb_k$());
            }
            ...
            continue $sm;
          case 12:
            if (compare(this.lineBuffer6__1.get_size_woubt6_k$(), fromInt(this.max_1)) >= 0) {
          ...
          case 14:
            var tmp_0 = this;
            var this_0 = compare(this.lineBuffer6__1.get_size_woubt6_k$(), new Long(0, 0)) > 0;
            if (this_0) {
              this.out_1.append_jgojdo_k$(readString(this.lineBuffer6__1));
            }

            tmp_0.tmp$ret$05__1 = this_0;
            this.set_exceptionState_fex74n_k$(21);
            this.set_state_rjd8d0_k$(15);
            var tmp_1 = this;
            continue $sm;
          ...
          case 16:
            ...
            var tmp_3 = this;
            closeFinally(this.this2__1, this.exception1__1);
            tmp_3.tmp$ret$60__1 = Unit_getInstance();
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            return this._this__u8e3s4__1.get_readBuffer_yjmj9b_k$().readByte_ectjk2_k$();
          case 3:
            throw this.get_exception_x0n6w6_k$();
        }
      } catch ($p) {
  ...
  function $readUntil$appendPartialMatchCOROUTINE$($writeChannel, matchBuffer, matchIndex, rc, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this.$writeChannel_1 = $writeChannel;
    this.matchBuffer_1 = matchBuffer;
    this.matchIndex_1 = matchIndex;
    this.rc_1 = rc;
  }
  protoOf($readUntil$appendPartialMatchCOROUTINE$).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
        switch (tmp) {
          case 0:
            this.set_exceptionState_fex74n_k$(2);
            this.set_state_rjd8d0_k$(1);
            suspendResult = writeFully(this.$writeChannel_1, this.matchBuffer_1, 0, this.matchIndex_1._v, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            ...
            continue $sm;
          case 1:
            var tmp0 = this.rc_1._v;
            var other = this.matchIndex_1._v;
            this.rc_1._v = add(tmp0, fromInt(other));
            this.matchIndex_1._v = 0;
            return Unit_getInstance();
          case 2:
            throw this.get_exception_x0n6w6_k$();
        }
  ...
  function LineEndingMode__equals_impl_qyr4nk($this, other) {
    if (!(other instanceof LineEndingMode))
      return false;
    if (!($this === (other instanceof LineEndingMode ? other.mode_1 : THROW_CCE())))
      return false;
    return true;
  }
  ...
  _.$_$.p1 = JvmSerializable;
  _.$_$.q1 = JvmSerializerReplacement;
  _.$_$.r1 = JvmSerializer;
  _.$_$.s1 = WriterScope;
  _.$_$.t1 = get_availableForRead;
  _.$_$.u1 = cancel_0;
  _.$_$.v1 = close_0;
  _.$_$.w1 = counted;
  _.$_$.x1 = invokeOnCompletion;
  _.$_$.y1 = get_isCompleted;
  _.$_$.z1 = readText;
  _.$_$.a2 = writer;
  //endregion
  return _;
